...
function StepItem({ icon, label, description }: Step ) {
  return (
    <div className="relative p-6 rounded-2xl bg-white backdrop-blur-xs border border-white/10 hover:border-rose-500/5 transition-colors duration-300 shadow-lg flex flex-col gap-4 h-full">
